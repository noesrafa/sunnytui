...
// OffsetIdx returns the index of the first visible item.
func (l *List) OffsetIdx() int { return l.offsetIdx }

// OffsetLine returns how many lines of the offsetIdx item are hidden above.
